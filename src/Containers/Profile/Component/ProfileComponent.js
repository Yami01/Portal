      ...
      <ScreenLayout scrollable style={[Layout.fill]}>
        <View style={[ProfileComponentStyles.container]}>
          ...
          <View style={{ flexDirection: "row", justifyContent: 'space-between', marginTop: 20 ,width: '100%'}}>
            <Button label = {"Quay lai"} onPress={handleSubmit(secondaryButtonPress)} btnStyle= {{width: '50%',}}></Button>
            <Button label = {"Quay lai"} onPress={() => primaryButtonPress(1)} btnStyle= {{width: '50%',}}></Button>
          </View>
        </View>
      </ScreenLayout>
    </ScreenContainer>
