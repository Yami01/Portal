...
const CreateNewPasswordComponent: AbstractComponent<PropsType> = memo((props: PropsType): Node => {
	...
	const titleNode = useMemo((): Node => {
		return (
			<View style={[Layout.colCenter]}>
				<Brand width={100}/>
				<Text style={[Fonts.textCenter, Fonts.textRegular]}>Create New Password</Text>
			</View>
		);
	}, [])
		...
		return (
			<View style={[Gutters.largeTMargin, Layout.colCenter, Layout.alignItemsStart, Gutters.regularRPadding]}>
				...
				<InputItem
					...
					labelNumber={1}
				/>
				<Text style={[Fonts.textSmall, Gutters.regularLMargin, Gutters.smallTMargin]}>New Password:</Text>
				<InputItem
					clear
					placeholderTextColor={Colors.black}
					labelNumber={2}
				/>
				<Text style={[Fonts.textSmall, Gutters.regularLMargin, Gutters.smallTMargin]}>Confirm new password:</Text>
				<InputItem
					clear
					placeholderTextColor={Colors.black}
					labelNumber={3}
				/>
				<Text style={[Fonts.textSmall, Gutters.regularLMargin, Gutters.smallTMargin]}>Code:</Text>
				<InputItem
					clear
					placeholderTextColor={Colors.black}
					labelNumber={4}
